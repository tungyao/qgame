...
void main(uint3 gid : SV_DispatchThreadID)
{
    ...
    for (uint i = 0; i < lightCount; ++i) {
        ...
        // Include softness in the culling radius so a tile just outside the
        // nominal light radius can still receive the soft penumbra generated by
        // area-light samples.
        float radiusScreen = (light.radius + max(light.softness, 0.0)) * safeZoom;
